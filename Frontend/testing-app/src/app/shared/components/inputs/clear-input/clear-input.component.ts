...
@Component({
  ...
  imports: [FormsModule],
  template: `
    <div class="clear-input-main">
      <div class="clear-input-wrapper">
        <input class="clear-input-input" type="text"
      ...
      @if (inputConfiguration.ErrorMessage != "") {
        <div class="clear-input-error">
          ...
          <p class="clear-input-error__message">
  ...
  `,
  styleUrl: './clear-input.component.scss'
})
