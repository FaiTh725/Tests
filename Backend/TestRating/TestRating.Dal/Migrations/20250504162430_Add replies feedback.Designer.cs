...
namespace TestRating.Dal.Migrations
{
    ...
    [Migration("20250504162430_Add replies feedback")]
    partial class Addrepliesfeedback
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TestRating.Domain.Entities.Feedback", b =>
                {
                    ...
                    b.Property<long?>("ParentFeedbackId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TestRating.Domain.Entities.Feedback", b =>
                {
                    ...
                    b.HasOne("TestRating.Domain.Entities.Feedback", "ParentFeedback")
                        .WithMany("Replies")
